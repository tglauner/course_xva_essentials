    ...
    2: {
      ...
      subsections: {
        ...
        4: {
          ...
          content: `
            <p>Basel III assigns a capital charge to CVA risk, recognizing its impact on bank solvency.</p>
            <ul>
              <li><strong>Capital Charge:</strong> covers spread volatility and jump-to-default risk.</li>
              <li><strong>Approaches:</strong> institutions may adopt standardized formulas or internal models.</li>
            </ul>
          `
        }
      }
