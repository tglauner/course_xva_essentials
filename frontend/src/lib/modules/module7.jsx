  ...
  return (
    <div className="space-y-4">
      <p>
        ...
        roadmap outlines the upcoming milestones that will transform Module 7 into a
...
export const module7Content = {
  title: "Module 7: Roadmap – Interactive Jupyter XVA Sandbox",
  subsections: {
    0: {
      title: "7.1 Roadmap Overview",
