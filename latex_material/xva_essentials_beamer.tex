...
\subtitle{45-Minute Lecture Covering Modules 1--6}
...
\begin{frame}{Pacing Strategy for 45 Minutes}
    \begin{itemize}
        ...
        \item 8 min: Module 1 highlights on XVA motivation and evolution.
        \item 12 min: Modules 2--3 covering CVA and DVA fundamentals.
        \item 12 min: Modules 4--5 on funding and margin adjustments.
        \item 8 min: Module 6 integration plus Q\&A or discussion bridge.
    \end{itemize}
    \note{Here is how I have structured the 45 minutes. We will start with a short scene-setting overview, then spend the largest block on CVA and DVA because they anchor all other adjustments. Funding and margin topics receive equal attention before we close by integrating the components and opening the floor for questions. Please keep this roadmap in mind as we progress.}
\end{frame}

\begin{frame}{Learning Outcomes}
    \begin{itemize}
        \item Recognise the economic drivers behind each core XVA component.
        \item Interpret fundamental valuation formulas for CVA, DVA, FVA, and MVA.
        ...
        \item Synthesise adjustments into an enterprise-wide XVA perspective.
    \end{itemize}
    \note{By the end of this lecture you should be able to recognise the economic drivers for each valuation adjustment, interpret the core formulas, and link them to operating model requirements. I also want you to appreciate the governance and regulatory expectations that surround XVA desks so you can synthesize an enterprise-wide perspective.}
\end{frame}
...
\section{Module 6: Integrated XVA}
